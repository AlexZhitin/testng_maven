...
public class Toast {
    ...
    private By toastSuccessClose = By.xpath("//*[@class='Toastify__close-button Toastify__close-button--success']");
    private By toastError = By.xpath("//*[@class='Toastify__toast Toastify__toast--error']");
    ...
    public boolean SuccessToastIsDisplayed() {
        ...
        public void closeToast() {
            ...
            try {
                WebDriverWait wait = new WebDriverWait(driver, 5);
                wait.until(ExpectedConditions.visibilityOfElementLocated(toastSuccessClose));
