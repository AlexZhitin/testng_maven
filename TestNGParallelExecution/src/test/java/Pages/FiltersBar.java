...
public class FiltersBar {
    ...
    private By filterLeagueSeleted = By.xpath("(//*[@data-id='filterLeague']//span[1]/span[1])[1]");
    private By filterTeam = By.xpath("//*[@data-id='filterTeam']");
    private By filterTeamSelected = By.xpath("(//*[@data-id='filterTeam']//span[1]/span)[1]");
    private By filterTeamDisabled = By.xpath("//*[@data-id='filterTeam']//button[@disabled]");
    private By filterGame = By.xpath("//*[@data-id='filterGame']");
    private By filterGameSelected = By.xpath("(//*[@data-id='filterGame']//button[1]/span[1]/span[1])[1]");
    private By filterGameDisabled = By.xpath("//*[@data-id='filterGame']//button[@disabled]");
    private By filterPlayer = By.xpath("//*[@data-id='filterPlayer']");
    private By filterPlayerDisabled = By.xpath("//*[@data-id='filterPlayer']//button[@disabled]");
    private By filterAction = By.xpath("//*[@data-id='filterAction']");
    private By filterActionDisabled = By.xpath("//*[@data-id='filterAction']//button[@disabled]");
    private By filterDate = By.xpath("//*[@data-id='filterDate']");
    private By filterDateDisabled = By.xpath("//*[@data-id='filterDate']//button[@disabled]");
    private By filterMoreFilters = By.xpath("//*[@data-id='filterMoreFilters']");
    private By filterMoreFiltersPopUp = By.xpath("//*[@data-id='filterMoreFiltersPopUp']");
    private By radiogroupRating = By.xpath("//*[@data-id='filterMoreFiltersPopUp']//*[@aria-label='rating']");
    private By radiogroupRatingOptions = By.xpath("//*[@data-id='filterMoreFiltersPopUp']//*[@aria-label='rating']//input[1]");
    private By radiogroupClipType = By.xpath("//*[@data-id='filterMoreFiltersPopUp']//*[@aria-label='clipType']");
    private By radiogroupClipTypeOptions = By.xpath("//*[@data-id='filterMoreFiltersPopUp']//*[@aria-label='clipType']//input[1]");
    private By filterBadges = By.xpath("//*[contains(@class,'MuiBadge-badge')]");

    private By filterMoreFiltersDisabled = By.xpath("//*[@data-id='filterMoreFilters']//button[@disabled]");
    private By noOptions = By.xpath("//*[@data-id='filterDropdown']//div[contains(text(),'No options')]");
    private By filterDropdown = By.xpath("//*[@data-id='filterDropdown']");
    private By leagueFilterInput = By.xpath("//*[@data-id='filterLeague']//input");
    private By dropdownOption = By.xpath("//*[@data-id='filterDropdown']/div[1]");
    private By dropdownOptions = By.xpath("//*[@data-id='filterDropdown']/div");
    private By applyButton = By.xpath("//*[@data-id='applyButton']");
    private By applyButtonDisabled = By.xpath("//*[@data-id='applyButton'][@tabindex='-1']");
    private By multiselectedOptions = By.xpath("//div[@x-placement]/div[1]/div[1]/div[1]/div[1]/div[1]/div[position() != last()][not(contains(text(), 'Search...'))]");
    private By removeMultiselectedOption = By.xpath("(//div[@x-placement]/div[1]/div[1]/div[1]/div[1]/div[1]/div[position() != last()]/div[2])[1]");
    private By removeMultiselectedOptions = By.xpath("//div[@x-placement]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]");
    private By datePicker = By.xpath("//*[@data-id='datePicker']");
    private By buttonSaveSearchEnabled = By.xpath("//*[@data-id='saveSearchButton'][not(@disabled)]");
    ...
    private By buttonEditEnabled = By.xpath("//*[@data-id='saveSearchButton'][not(@disabled)]/span[contains(text(), 'Edit')]");
    private By buttonEditDisabled = By.xpath("//*[@data-id='saveSearchButton'][@disabled]/span[contains(text(), 'Edit')]");
    private By toastClose = By.xpath("//*[@class='Toastify__close-button Toastify__close-button--success']");
    private By monthYear = By.xpath("(//*[@data-id='datePicker']//*[@data-visible='true']//strong)[2]");
    private By days = By.xpath("(//*[@data-id='datePicker']//*[@data-visible='true']//strong)[2]//following::*[contains(@aria-label,'check-in')]");
    private By datePickerBackButton = By.xpath("//*[@data-id='datePicker']//*[@aria-label='Move backward to switch to the previous month.']");
    ...
    public boolean LeagueFilterIsDisplayedEnabled() {
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterLeague));
    ...
    public boolean TeamFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterTeam));
    ...
    public boolean TeamFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterTeamDisabled));
    ...
    public boolean GameFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterGame));
    ...
    public boolean GameFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterGameDisabled));
    ...
    public boolean PlayerFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterPlayer));
    ...
    public boolean PlayerFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterPlayerDisabled));
    ...
    public boolean ActionFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterAction));
    ...
    public boolean ActionFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterActionDisabled));
    ...
    public boolean DateFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterDate));
    ...
    public boolean DateFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterDateDisabled));
    ...
    public boolean MoreFilterIsDisplayedEnabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterMoreFilters));
    ...
    public boolean MoreFilterIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterMoreFiltersDisabled));
    ...
    public int MultiSelectedOptionsCount() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(multiselectedOptions));
    ...
    public void PutInLeagueName(String leagueName) {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 10);
            wait.until(ExpectedConditions.visibilityOfElementLocated(leagueFilterInput));
    ...
    public void clickOnLeagueFilterSelected() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 10);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterLeagueSeleted));
    ...
    public String SelectedTeamNameOnFilter() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterTeamSelected));
    ...
    public String SelectedGameNameOnFilter() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterGameSelected));
    ...
    public boolean ApplyButtonIsDisplayedDisabled() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(applyButtonDisabled));
    ...
    public void RemoveSelectedOption() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(removeMultiselectedOption));
    ...
    public void RemoveSelectedOptions() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(removeMultiselectedOptions));
            WebElement removeAll = driver.findElement(removeMultiselectedOptions);
            removeAll.click();
        } catch (Throwable e) {
            ExtentTestManager.getTest().log(Status.INFO, e);
            System.out.println(e);
    ...
    public boolean MoreFiltersPopUpIsDisplayed() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(filterMoreFiltersPopUp));
    ...
    public boolean RatingRadiogroupIsDisplayed() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(radiogroupRating));
    ...
    public boolean ClipTypeRadiogroupIsDisplayed() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(radiogroupClipType));
    ...
    public boolean SaveButtonIsEnabled() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(buttonSaveSearchEnabled));
    ...
    public boolean EditButtonIsDisabled() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(buttonEditDisabled));
    ...
    public boolean EditButtonIsEnabled() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(buttonEditEnabled));
    ...
    public void PresetNameInput(String value) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(inputPresetName));
  ...
  /*public void SelectDate(String dateFrom) {
    try {
      WebDriverWait wait = new WebDriverWait(driver, 5);
      wait.until(ExpectedConditions.visibilityOfElementLocated(dateCheckIn));
      WebElement date = driver.findElement(toastClose);
      date.click();
    } catch (Throwable e) {
      ExtentTestManager.getTest().log(Status.INFO, e);
      System.out.println(e);
    ...
    public void SelectDate(String date) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(monthYear));
            ...
            wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(monthYear));
    ...
    public void selectRating(String rating) {
        ...
        try {
            ...
            List<WebElement> optionsRating = driver.findElements(radiogroupRatingOptions);
    ...
    public void selectClipType(String type) {
        ...
        try {
            /*WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(radiogroupClipTypeOptions));*/
            List<WebElement> optionsClipType = driver.findElements(radiogroupClipTypeOptions);
    ...
    public int FilterBadgesCount() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(filterBadges));
