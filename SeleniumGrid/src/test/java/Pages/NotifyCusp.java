...
public class NotifyCusp {
    ...
    private By fieldDescription = By.xpath("//*[@data-id='descriptionField']//textarea[1]");
    private By errorTitle = By.xpath("//*[@data-id='errorTitle']");
    private By buttonSendEnabled = By.xpath("//*[@data-id='buttonSend'][not(@disabled)]");
    private By buttonSendDisabled = By.xpath("//*[@data-id='buttonSend'][@disabled]");
    ...
    public boolean NotifyCuspDialogIsDisplayed() {
        ...
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(dialogNotify));
    ...
    public void putInDescription(String input) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(fieldDescription));
    ...
    public boolean ErrorTitleIsDisplayed() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(errorTitle));
    ...
    public boolean SendButtonIsDisabled() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(buttonSendDisabled));
    ...
    public boolean SendButtonIsEnabled() {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.visibilityOfElementLocated(buttonSendEnabled));
